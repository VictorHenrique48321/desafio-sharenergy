...
import { Box, Button, Card, CardHeader, CardMedia, Link, Typography } from '@mui/material/node'
...
const ArticlePageInfo = (props) => {
  ...
  return (
    <Box sx={{
      ...
      <Box sx={{width: {"xs": "100%", "md": "60%"}, margin: "0 auto", display: "flex", justifyContent: "space-around", marginBottom: {"xs": "1rem", "lg": "0"}}}>
